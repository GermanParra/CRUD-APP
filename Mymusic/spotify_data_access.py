...
def search_albums(input_string):
    '''Takes user's input string and pull the information for
        5 related albums from the Spotify Database'''
    Albums = spotify.search(input_string,
                            limit=5,
                            offset=0,
                            type='album',
                            market=None
